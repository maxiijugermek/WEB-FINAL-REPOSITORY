              ...
              <td valign="top">
					...
					<?php 
						...
						if (isset($title) && isset($meta_d) && isset($meta_k) && isset($date) && isset($description) && isset($text) && isset($author)){
							...
							$result = mysql_query("update articles set title='$title', meta_d='$meta_d', meta_k='$meta_k', date='$date', description='$description', text='$text', author='$author' where id='$id'",$db);
							if ($result == true){
